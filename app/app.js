document.addEventListener('DOMContentLoaded', () => {
    const BASE_TEXT_TOP =
        'Create/generate now (without any questions) an 3:4 image with a raccoon with a tail, integrated into the far midground environment of the background, strictly by the following description in this whole text. Camera distance must be far enough so the raccoon appears smaller, covering only 65–75% of the whole frame height. Full body must be completely visible. Do not place the raccoon in the close foreground. Keep it visually distant within the scene.';
    ...
    const LABEL_TEXTS = {
        ...
        tail: {
            '001': 'Просто лапки',
            '002': 'Молот Тора',
            '003': 'Стеклянный меч Скайрим',
            '004': 'Щит Капитан Ракун',
            '005': 'Миниган М134'
        },
        camera: {
            '001': 'Прямой ракурс',
